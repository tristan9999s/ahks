MsgBox Novulent injecting... Press "OK" to continue
#NoEnv
...
MsgBox, Novulent - Failed to locate settings.json file, make sure you have the settings.json file downloaded on your computer, Closing.
ExitApp
}
AimbotKey := config.Novulent.Binds.Keybind
PauseKey := config.Novulent.Binds.Pause
Saturation := config.Novulent.Color.Saturation
LinearCurveX := config.Novulent.Bezier.LinearCurveX
LinearCurveY := config.Novulent.Bezier.LinearCurveY
CameraToGunFOV := config.Novulent.Misc.CameraToGunFOV
AimbotUpdateTick := config.Novulent.Misc.AimbotUpdateTick
SmoothnessX := config.Novulent.Easing.SmoothnessX / LinearCurveX
SmoothnessY := config.Novulent.Easing.SmoothnessY / LinearCurveY
SmoothingReplicatorX := config.Novulent.Easing.SmoothingReplicatorX
SmoothingReplicatorY := configc.Novulent.Easing.SmoothingReplicatorY
SmoothingDividerX := config.Novulent.Easing.SmoothingDividerX
SmoothingDividerY := config.Novulent.Easing.SmoothingDividerY
FOVOffsetX := config.Novulent.FOV.FOVOffsetX
FOVOffsetY := config.Novulent.FOV.FOVOffsetY
FlickTime := config.Novulent.Misc.FlickTime
AimbotMS := config.Novulent.Misc.AimbotUpdateMS
Prediction := config.Novulent.Easing.Prediction.Enabled
PredictionMode := config.Novulent.Easing.Prediction.Mode
PredictionX := config.Novulent.Easing.Prediction.PredictionX
PredictionY := config.Novulent.Easing.Prediction.PredictionY
FallbackPixelX := 0
FallbackPixelY := 0
